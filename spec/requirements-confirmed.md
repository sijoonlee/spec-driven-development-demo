# Requirements: Customer CRUD API (Confirmed)
...
- [ ] lastName is optional (can be omitted or null)
- [ ] phoneNumber is optional (can be omitted or null)
...
- [ ] Only firstName is required; lastName and phoneNumber are optional
